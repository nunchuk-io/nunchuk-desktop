...
QScreen {
                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            readonly property var content_map: [
                                {height: 84, headline:STR.STR_QML_818, content: STR.STR_QML_819 , icon: "qrc:/Images/Images/1.Active.svg" },
                                {height: 112, headline:STR.STR_QML_095, content: STR.STR_QML_820 , icon: "qrc:/Images/Images/2.Active.svg" },
                                {height: 112, headline:STR.STR_QML_821, content: STR.STR_QML_822 , icon: "qrc:/Images/Images/3.Active.svg" },
                            ]
    ...
    readonly property string _LEDGER: "Ledger"
    readonly property string _LEDGER_TYPE: "ledger"
    QOnScreenContentTypeA {
        ...
        content: Item {
                ...
                Rectangle {
                    ...
                    QListView {
                        ...
                        delegate: Item {
                            width: 342
                            height: 44
                            visible: device_type === _LEDGER_TYPE
                            Rectangle {
                                id: rect
            ...
            function scanDevice() {
                QMLHandle.sendEvent(EVT.EVT_SCAN_LEDGER_DEVICE_REQUEST)
            }
            function addDevice() {
                if(devicelist.currentIndex !== -1){
                    var masterSignerObj = { "signerNameInputted"    : signerName,
                        "deviceIndexSelected"   : devicelist.currentIndex};
                    QMLHandle.sendEvent(EVT.EVT_ADD_LEDGER_DEVICE_REQUEST, masterSignerObj)
                }
            }
        }
        onPrevClicked: {
    ...
    QPopupInfo{
        id:_info1
        contentText: STR.STR_QML_840_LEDGER
        onGotItClicked: {
            close()
        }
    }
