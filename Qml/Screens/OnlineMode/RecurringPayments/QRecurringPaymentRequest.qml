...
QOnScreenContentTypeB {
    ...
    content: Column {
        ...
        QLato {
            ...
            text: STR.STR_QML_1150.arg(requester_user.name).arg(requester_user.email).replace("()","")
    ...
    bottomRight: QTextButton {
        width: 219
        height: 48
        label.text: STR.STR_QML_1151
        label.font.pixelSize: 16
        type: eTypeE
        onButtonClicked: {
            var _input = {
                type: "review-recurring-payment"
            }
