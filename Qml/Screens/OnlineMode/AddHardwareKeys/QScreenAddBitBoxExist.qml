...
QScreenAdd {
    ...
    // Use shared state/flow pattern like Coldcard screen
    ...
    // Screen: input/change account index
    Component {
    ...
    // Screen: scan devices and verify signer
    Component {
        id: _scanDevices
        QOnScreenContentTypeA {
            id: scanDevices
