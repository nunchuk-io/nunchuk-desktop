...
QScreenAdd {
                                    ...
                                    Row {
                                        ...
                                        Column {
                                            ...
                                            QText {
                                                ...
                                                onLinkActivated: Qt.openUrlExternally("https://www.ledger.com/start")
                                            }
                                        }
                                    }
                                }
    ...
    Component {
        ...
        QOnScreenContentTypeA {
            ...
            content: QAddKeyRefreshDevices {
                title: STR.STR_QML_824
                state_id: EVT.STATE_ID_SCR_ADD_HARDWARE
            }
            onPrevClicked: stateScreen.setScreenFlow("eSCREEN_INFORMATION")
    ...
    Component {
        ...
        QScreenAddKeyResult {
            ...
            resultTitle: isSuccess ? STR.STR_QML_827 : STR.STR_QML_964
