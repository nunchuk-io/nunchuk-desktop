            ...
            QVerifyYourInheritanceKeySeedPhraseQuestion {
                ...
                onNextClicked: {
                    ...
                    if (verify_option === "SKIPPED_VERIFICATION") {
                        draftWallet.requestVerifySingleSigner(-1, selected_verify_option)
                    } else {
            ...
            QOnScreenContentTypeA {
                ...
                bottomRight: Row {
                    ...
                    QTextButton {
                        ...
                        onButtonClicked: {
                            draftWallet.requestVerifySingleSigner(_refresh.contentItem.mDevicelist.currentIndex, selected_verify_option)
                        }
                    }
                }
            }
