    ...
    QOnScreenContent {
        ...
        Item {
            ...
            Row {
                ...
                Repeater {
                    model: [STR.STR_QML_1491, STR.STR_QML_1492]
                    delegate: Item {
                        width: 364
                        height: 48
                        Row {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        QListView {
                            ...
                            delegate: Rectangle {
                                width: unUsed.width - 8  // leave room for QScrollBar (8px)
                                height: 48
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        QListView {
                            ...
                            ScrollBar.vertical: QScrollBar { }
                            delegate: Item {
                                width: used.width - 8  // leave room for QScrollBar (8px)
                                height: 132
                                Row {
                                    anchors.fill: parent
                                    anchors.margins: 18
