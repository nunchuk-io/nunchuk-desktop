...
QOnScreenContentTypeA {
    ...
    CreateInheritancePlanViewModel {
        id: vm
    }
    ...
    property string title: QSTR.STR_QML_1035.arg(vm.requester_user.name).arg(vm.requester_user.email).arg(vm.walletName).replace("()","")
    content: Item {
        id: _item
        Column {
            spacing: 16
