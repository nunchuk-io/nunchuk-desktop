...
QOnScreenContent {
                                ...
                                if(master_signer_checked){
                                    ...
                                    if(master_signer_type == NUNCHUCKTYPE.SOFTWARE || model.master_signer_primary_key){
                                        ...
                                        if(signerConfigRoot.walletAddressType === NUNCHUCKTYPE.TAPROOT){
                                            var assignedCnt = newWalletInfo.walletSingleSignerAssigned.signerCount()
                ...
                QText {
                    ...
                    text: {
                        ...
                        if(newWalletInfo.walletM === 0){
                            ...
                            ret = STR.STR_QML_559.arg(newWalletInfo.walletM).arg(newWalletInfo.walletN)
                        }
                        return ret;
                    }
                    font.weight: Font.Bold
            ...
            Row {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        onClicked: {
                            if(newWalletInfo.walletM < signerAssigned.count){
                                newWalletInfo.walletM++;
                            }
                        }
                    }
    ...
    QTextButton {
        ...
        label.font.pixelSize: 16
        type: eTypeE
        enabled: (newWalletInfo.walletM > 0) && (signerAssigned.count > 0) && (newWalletInfo.walletM <= signerAssigned.count)
        anchors {
            right: parent.right
            rightMargin: 40
            bottom: parent.bottom
