    ...
    Item{
        ...
        Column{
            ...
            Column{
                spacing: 28
                width: parent.width
                height: txt1.height + txt2.height + spacing
                QText {
                    id:txt1
                    ...
                    anchors.horizontalCenter: parent.horizontalCenter
                    horizontalAlignment: Text.AlignHCenter
                    text: deletingModelRoot.content_1
                    font.family: "Lato"
                    font.pixelSize: 16
                }
                QText {
                    id:txt2
                    width: parent.width - 24*2
                    height: 48//txt2.paintedHeight
                    wrapMode: Text.WordWrap
                    anchors.horizontalCenter: parent.horizontalCenter
                    horizontalAlignment: Text.AlignHCenter
                    text: deletingModelRoot.content_2
                    font.family: "Lato"
                    font.pixelSize: 16
                }
            }
