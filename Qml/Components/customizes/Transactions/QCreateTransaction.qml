            ...
            Column {
                ...
                Item {
                    ...
                    QSwitchTypeB {
                        ...
                        switchOn: QMLHandle.onsRequester() === EVT.STATE_ID_SCR_CONSOLIDATE_OUTPUT
                    }
                }
                Column {
                    ...
                    Column {
                        ...
                        QTextInputBox {
                            ...
                            errorText.text: STR.STR_QML_230.arg(AppModel.minFee)
                            validInput: {
                                if(feeinput.textOutput === "") {return true}
                                else{
                                    return parseFloat(feeinput.textOutput) >= AppModel.minFee
                                }
