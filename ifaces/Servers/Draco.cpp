...
{
    return QRest::dracoToken();
}

void Draco::setDracoToken(const QString token)
{
    QRest::setDracoToken(token);
}

QByteArray Draco::machineUniqueId()
{
    return QRest::machineUniqueId();
}
...
void Draco::checkAccountAvailability(const QString &email)
{
    ...
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::ACCOUNT_AVAILABILITY], data, reply_code, reply_msg);
...
bool Draco::getCurrencies(QJsonObject &output, QString &errormsg)
{
    int reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::GET_CURRENCIES], QJsonObject(), reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        output = jsonObj;
        return true;
    }
...
void Draco::verifyNewDevice(const QString &pin)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::VERIFY_NEW_DEVICE], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::resendVerifyNewDeviceCode()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::RESEND_VERIFY_NEW_DEVICE_CODE], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::inviteFriends(const QStringList& emails)
{
    if(emails.count() > 0){
        ...
        int     reply_code = -1;
        QString reply_msg  = "";
        QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::INVITE_FRIEND], data, reply_code, reply_msg);
        if(reply_code == DRACO_CODE::SUCCESSFULL){
            QJsonObject errorObj = jsonObj["error"].toObject();
            int response_code = errorObj["code"].toInt();
            QString response_msg = errorObj["message"].toString();
...
void Draco::removeContact(const QString &contact_id)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->deleteSync(commands[Common::CMD_IDX::REMOVE_FRIEND], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::cancelFriendRequest(const QString &contact_id)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->deleteSync(commands[Common::CMD_IDX::CANCEL_REQUEST_FRIEND], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::createAccount(const QString& name, const QString& email)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::CREATE_ACCOUNT], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::singin(const QString& email, const QString& password)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::SIGNIN], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL) {
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::signout()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::SIGNOUT], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        reset();
...
void Draco::recoverPassword(const QString& email, const QString& forgotToken, const QString& newpassword)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::RECOVER_PASSWORD], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code    = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::forgotPassword(const QString& email)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::FORGOT_PASSWORD], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::resendPassword(const QString &email)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::RESEND_PASSWORD], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::changePassword(const QString& oldpassword, const QString& newpassword)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::CHANGE_PASSWORD], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::getMe()
{
    ...
    QString reply_msg  = "";
    DracoUser user;
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::GET_ME], QJsonObject(), reply_code, reply_msg);
    DBG_INFO << jsonObj;
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        ...
        if(response_code == DRACO_CODE::RESPONSE_OK){
            ...
            if (user.login_type == "PRIMARY_KEY") {
                setUid(user.username);
            } else {
                setUid(user.email);
            }            
            setEmailRequested(user.email);
...
DracoUser Draco::search(const QString &email)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::SEARCH_FRIEND], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QVariant Draco::requestFriends(const QVariant emails)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->putSync(commands[Common::CMD_IDX::REQUEST_FRIEND], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::requestSingleFriend(const QString &email)
{
    ...
    if(user.id != ""){
        ...
        int     reply_code = -1;
        QString reply_msg  = "";
        QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::REQUEST_FRIEND], data, reply_code, reply_msg);
        if(reply_code == DRACO_CODE::SUCCESSFULL){
            QJsonObject errorObj = jsonObj["error"].toObject();
            int response_code = errorObj["code"].toInt();
            QString response_msg = errorObj["message"].toString();
...
QList<DracoUser> Draco::getContacts()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::GET_FRIENDS_LIST], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QList<DracoUser> Draco::getContactsSent()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::GET_FRIENDS_SENT], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QList<DracoUser> Draco::getContactsReceived()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::GET_FRIENDS_RECEIVED], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QList<DracoDevice> Draco::getDevices()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Common::CMD_IDX::GET_DEVICES_LIST], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::accecptFriendRequest(const QString &id)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::ACCEPT_FRIEND_REQUEST], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::ignoreFriendRequest(const QString &id)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->deleteSync(commands[Common::CMD_IDX::IGNORE_FRIEND_REQUEST], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::deleteCurrentUser()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->deleteSync(commands[Common::CMD_IDX::DELETE_ACCOUNT], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::sendDeleteConfirmation(const QString &code)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::DELETE_CONFIRM], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::setUserProfile(const QString &name, const QString &avartaPath)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::USER_PROFILE], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::signoutDeice(const QString &device_id)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->deleteSync(commands[Common::CMD_IDX::DEVICE_SIGNOUT], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::signoutAllDeices()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->deleteSync(commands[Common::CMD_IDX::DEVICE_ALL_SIGNOUT], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
void Draco::markAsCompromised(const QString &device_id)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Common::CMD_IDX::DEVICE_MARK_COMPROMISED], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::pkey_signup(const QString &address, const QString &username, const QString &signature)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_SIGNUP], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::pkey_signin(const QString &address, const QString &username, const QString &signature)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_SIGNIN], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QString Draco::get_pkey_nonce(const QString &address,const QString &username)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_NONCE], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QString Draco::pkey_manual_nonce(const QString &address, const QString &username, const QString &nonce, const QString &type)
{
    ...
    if(type == "change_pkey"){
        ...
        jsonObj = m_rest->postSync(cmd, data, reply_code, reply_msg);
    }else{
        jsonObj = m_rest->postSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_NONCE], data, reply_code, reply_msg);
    }
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::pkey_username_availability(const QString &username, QJsonObject &errorObj)
{
    QJsonObject data;
    data["username"] =  username;
    bool ret = false;
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_USERNAME], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
        if(response_code == DRACO_CODE::RESPONSE_OK){
            ret = true;
...
bool Draco::pkey_username_availability(const QString &username)
{
    ...
    return pkey_username_availability(username, errorObj);
}
...
bool Draco::pkey_delete_confirmation(const QString &signed_message)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_DELETE_CONFIRMTION], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::pkey_change_pkey(const QString &new_key, const QString &old_signed_message, const QString &new_signed_message)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[PrimaryKey::CMD_IDX::PRIMARY_KEY_CHANGE_KEY], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::assistedWalletGetListKey(QJsonObject &output, QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::ASSISTED_WALLET_GET_LIST_KEY], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::assistedWalletAddKey(const QString &request_id,
                                 ...
                                 QJsonObject &output)
{
    ...
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::ASSISTED_WALLET_ADD_KEY],
                                           paramsQuery, {}, data, reply_code, reply_msg);
    if (reply_code == DRACO_CODE::SUCCESSFULL) {
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code    = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QJsonObject Draco::assistedGetWalletConfig()
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::ASSISTED_WALLET_GET_CONFIG], {}, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::verifyPasswordToken(const QString& password, const int action, QString& string_token, QString &errormsg)
{
    ...
    QJsonObject jsonObj = m_rest->postSync(command, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QString Draco::randomNonce()
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::GET_RANDOM_NONCE], QJsonObject(), reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::secQuesGet(QJsonObject& output, QString& errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::SEC_QUES_GET], QJsonObject(), reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                            ...
                                            QString &errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::SEC_QUES_REQUIRED_SIGNATURES], request_body, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                          ...
                          QString& errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::SEC_QUES_VERIFY_ANSWER], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::lockdownPeriods(QJsonArray& output, QString& errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::LOCKDOWN_GET_PERIOD], QJsonObject(), reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                       ...
                                       QString& errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::LOCKDOWN_REQUIRED_SIGNATURES], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                    ...
                                    QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::LOCKDOWN_SET_ANSWER_SECURITY_QUESTION], {}, params, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                  ...
                                  QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::LOCKDOWN_SET_SIGN_DUMMY_TX], {}, params, data, reply_code, reply_msg);
    qInfo() << jsonObj;
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
                                       ...
                                       QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(cmd, {}, params, body, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                   ...
                                   QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::USER_KEYS_GET_LIST_USER_KEYS], params, {}, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::UserKeysCreateUserCustomizedQuestion(const QString &question, QJsonObject &output, QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::SEC_QUES_CREATE], {}, {}, body, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::inheritanceDownloadBackup(const QString& magic,
    ...
    QJsonObject &output)
{
    ...
    QString cmd = commands[Premium::CMD_IDX::INHERITANCE_CLAIM_DOWNLOAD_BACKUP];
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(cmd, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
...
bool Draco::inheritanceClaimRequest(const QJsonObject& data,
    QJsonObject& output)
{
    ...
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        ...
        if(response_code == DRACO_CODE::RESPONSE_OK){
            ...
            AppModel::instance()->showToast(response_code, output["message"].toString(), EWARNING::WarningType::EXCEPTION_MSG);
            return false;
        }
    }
    return false;
...
bool Draco::inheritanceClaimStatus(const QJsonObject& data,
...
bool Draco::inheritanceClaimInit(const QString& magic,
    QJsonObject& output) {
    QJsonObject data;
    data["magic"] = magic;
    QString cmd = commands[Premium::CMD_IDX::INHERITANCE_CLAIM_INIT];
    int reply_code = -1;
    QString reply_msg = "";
    QJsonObject jsonObj = m_rest->postSync(cmd, data, reply_code, reply_msg);
    if (reply_code == DRACO_CODE::SUCCESSFULL) {
...
bool Draco::inheritanceClaimDownloadWallet(const QJsonObject &body, QJsonObject &output) {
    QString cmd = commands[Premium::CMD_IDX::INHERITANCE_CLAIM_DOWNLOAD_WALLET];
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(cmd, body, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
...
bool Draco::inheritanceCreateTx(const QJsonObject& data, const QStringList& authos, QJsonObject &output)
{
    ...
    QString cmd = commands[Premium::CMD_IDX::INHERITANCE_CLAIM_CREATE_TX];
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(cmd, {}, params, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
...
bool Draco::inheritanceCheck(const QString& magic, const QString& environment, QJsonObject& output)
{
    QJsonObject data;
    data["magic"] = magic;
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::INHERITANCE_CHECK], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        output = jsonObj["error"].toObject();
        int response_code = output["code"].toInt();
        QString response_msg = output["message"].toString();
...
bool Draco::inheritanceGetPlan(const QString& wallet_id, const QString &group_id, QJsonObject &output, QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::INHERITANCE_GET_PLAN], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
//    paramsQuery["draft"] = isDraft ? "true" : "false";
    ...
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::INHERITANCE_PLAN_CREATE], paramsQuery, params, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                  ...
                                  QString &errormsg)
{
    ...
    QJsonObject jsonObj = m_rest->putSync(commands[Premium::CMD_IDX::INHERITANCE_PLAN_UPDATE], paramsQuery, params, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                  ...
                                  QString &errormsg)
{
    ...
    QJsonObject jsonObj = m_rest->deleteSync(commands[Premium::CMD_IDX::INHERITANCE_PLAN_CANCEL], paramsQuery, params, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::inheritanceFakeUpdate()
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->putSync(commands[Premium::CMD_IDX::INHERITANCE_FAKE_UPDATE], data, reply_code, reply_msg);
    qInfo() << jsonObj;
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::inheritancePlanRequiredSignatures(const QJsonObject &data, QJsonObject &output, QString &errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::INHERITANCE_PLAN_REQUIRED_SIGNATURES], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::inheritancePlanBufferPeriod(QJsonArray& output, QString& errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->getSync(commands[Premium::CMD_IDX::INHERITANCE_PLAN_BUFFER_PERIODS], QJsonObject(), reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::InheritancePlanningRequestApprove(const QString &request_id, const QString &wallet_id, const QString &group_id, QString &errormsg)
{
    ...
    QJsonObject jsonObj = m_rest->putSync(cmd, paramsQuery, {}, {}, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                                        ...
                                        QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::CONFIRMATION_CODE], paramsQuery, {}, requestBody, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::RequestOnboardingNoAdvisor(const QString &country_code, const QString &email, const QString &note, QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::ONBOARDING_NO_ADVISOR], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
                        ...
                        QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::CHANGING_EMAIL], paramsQuery, params, request_body, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::CalculateRequireSignaturesForChangingEmail(const QString &new_email, QJsonObject &output, QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::CALCULATE_REQUIRED_SIGNATURES_FOR_CHANGING_EMAIL], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::ConfigureWalletReplacement(const QString &wallet_id, QJsonObject &output, QString &errormsg)
{
    ...
    cmd.replace("{wallet_id_or_local_id}", wallet_id);
    QJsonObject jsonObj = m_rest->putSync(cmd, {}, reply_code, reply_msg);
    if (reply_code == DRACO_CODE::SUCCESSFULL) {
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::ReplaceKey(const QString &wallet_id, const QString &xfp, const QString& passwordToken, const QJsonObject& request_body, QJsonObject &output)
{
    if (wallet_id.isEmpty()) return false;
    int     reply_code = -1;
    QString reply_msg  = "";
...
bool Draco::FinalizeKeyReplacement(const QString &wallet_id, const QString& passwordToken, QJsonObject &output, QString &errormsg)
{
    if (wallet_id.isEmpty()) return false;
    int     reply_code = -1;
    QString reply_msg  = "";
...
bool Draco::ResetKeyReplacement(const QString &wallet_id, const QString& passwordToken, QJsonObject &output, QString &errormsg)
{
    if (wallet_id.isEmpty()) return false;
    int     reply_code = -1;
    QString reply_msg  = "";
...
bool Draco::VerifyKeyReplacement(const QString &wallet_id, const QString &xfp, const QString& type, const QString& passwordToken, QJsonObject& result)
{
    ...
    int reply_code = -1;
    QString reply_msg = "";
    QString cmd = commands[Premium::CMD_IDX::ASSISTED_WALLET_VERIFY_KEY_REPLACEMENT];
    cmd.replace("{wallet_id_or_local_id}", wallet_id);
    cmd.replace("{xfp}", xfp);
...
bool Draco::RemoveKeyReplacement(const QString &wallet_id, const QString &xfp, const QString& passwordToken, QJsonObject& result) {
    if (wallet_id.isEmpty() || xfp.isEmpty()) return false;
    ...
    QMap<QString, QString> params;
    params["Verify-token"] = passwordToken;
    QString cmd = commands[Premium::CMD_IDX::ASSISTED_WALLET_REMOVE_KEY_REPLACEMENT];
    cmd.replace("{wallet_id_or_local_id}", wallet_id);
    cmd.replace("{xfp}", xfp);
...
bool Draco::SignDummyTransactionToSignIn(const QString &dummy_transaction_id, const QStringList& signatures, QJsonObject &output, QString &errormsg)
{
    ...
    QJsonObject jsonObj = m_rest->putSync(cmd, {}, params, {}, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
bool Draco::SignInUsingXPUBorWallet(const QString &bsms, QJsonObject &output, QString &errormsg)
{
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QJsonObject jsonObj = m_rest->postSync(commands[Premium::CMD_IDX::SIGN_IN_USING_XPUB_WALLET], data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
...
QJsonArray Draco::GetTaprootSupportedCached(bool reset)
{
    if(reset && m_taproot_support_types.size() > 0){
        m_taproot_support_types = {};
    }
    if(m_taproot_support_types.count() == 0){
        ...
        if(get_result){
            m_taproot_support_types = data["supported_signers"].toArray();
        }
    }
...
{
    QFunctionTime f(__PRETTY_FUNCTION__);
    QUrl url = QUrl::fromUserInput("https://api.nunchuk.io/v1.1/app/electrum");
    QNetworkRequest requester_(url);
    requester_.setHeader(QNetworkRequest::ContentTypeHeader, "application/json");
    ...
    if (reply->error() == QNetworkReply::NoError) {
        QByteArray response_data = reply->readAll();
        QJsonDocument json = QJsonDocument::fromJson(response_data);
        output = json["data"].toObject();
    }
    return true;
}

bool Draco::ElectrumGetPaidServers(QJsonObject &output, QString &errormsg)
{
    QFunctionTime f(__PRETTY_FUNCTION__);
    QJsonObject data;
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = "https://api.nunchuk.io/v1.1/app/electrum";
    QJsonObject jsonObj = m_rest->getSync(cmd, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::changeAvatar(const QString &filePath, QString &errormsg)
{
    QString url = "https://your-api-domain.com/v1.1/user/me/change-avatar"; // Sửa lại nếu cần
    ...
    imagePart.setHeader(QNetworkRequest::ContentDispositionHeader,
                        QVariant(QString("form-data; name=\"avatar\"; filename=\"%1\"").arg(fileName)));
    ...
    request.setRawHeader("Authorization", QString("Bearer %1").arg(dracoToken()).toUtf8());
    request.setRawHeader("Connection", "keep-alive");
    request.setRawHeader("x-nc-device-id", machineUniqueId());
    request.setRawHeader("x-nc-app-version", qApp->applicationVersion().toUtf8());
    request.setRawHeader("x-nc-device-class", "Desktop");
    request.setRawHeader("x-nc-os-name", QSysInfo::productType().toUtf8());

    OurSharedPointer<QNetworkAccessManager> manager = m_rest->networkManager();
    if (manager.isNull()) {
        errormsg = "Invalid network manager.";
        return false;
    }
    ...
    if (httpCode >= 200 && httpCode < 300) {
        ...
        errormsg = QString("HTTP %1").arg(httpCode);
        return false;
    }
}

bool Draco::removeAvatar(QJsonObject &output, QString &errormsg)
{
    QJsonObject data;
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Common::CMD_IDX::REMOVE_AVATAR];
    QJsonObject jsonObj = m_rest->deleteSync(cmd, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::GetWalletSetupConfig(QJsonObject &output, QString &errormsg)
{
    QJsonObject data;
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CONFIG_WALLET_SETUP];
    QJsonObject jsonObj = m_rest->getSync(cmd, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::DraftWalletUpdateTimelock(const QJsonObject& request_body, QJsonObject &output, QString &errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
...
bool Draco::walletChangeTimelock(const QString &wallet_id, const QJsonObject& request_body, const QString &verify_token, QJsonObject &output)
{
    QMap<QString, QString> params;
    params["Verify-token"] = verify_token;
    // TOken using action TARGET_ACTION::REPLACE_KEY

    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::ASSISTED_WALLET_REPLACEMENT_TIMELOCK];
    cmd.replace("{wallet_id_or_local_id}", wallet_id);
...
bool Draco::ClaimingWalletGet(const QString &local_id, QJsonObject &output, QString &errormsg)
{
    int reply_code = -1;
    QString reply_msg = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_GET_BY_ID];
    cmd.replace("{local_id}", local_id);
    QJsonObject jsonObj = m_rest->getSync(cmd, QJsonObject(), reply_code, reply_msg);
    if (reply_code == DRACO_CODE::SUCCESSFULL) {
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::ClaimingWalletUpdate(const QString &local_id, const QString &name, const QString &description, QJsonObject &output, QString &errormsg)
{
    int reply_code = -1;
    QString reply_msg = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_UPDATE_BY_ID];
    cmd.replace("{local_id}", local_id);
...
bool Draco::ClaimingWalletDelete(const QString &local_id, QJsonObject &output, QString &errormsg)
{
    int reply_code = -1;
    QString reply_msg = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_DELETE_BY_ID];
    cmd.replace("{local_id}", local_id);
...
bool Draco::ClaimingWalletList(QJsonObject &output, QString &errormsg)
{
    int reply_code = -1;
    QString reply_msg = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_LIST];
    QJsonObject jsonObj = m_rest->getSync(cmd, QJsonObject(), reply_code, reply_msg);
    if (reply_code == DRACO_CODE::SUCCESSFULL) {
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
QJsonObject Draco::ClaimingWalletTransactionGetList(const QString &wallet_id)
{
    QJsonObject data;
    data["offset"] = "0";
    data["limit"] = "100";
    ...
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_TX_GET_LIST];
    cmd.replace("{local_id}", wallet_id);
    QJsonObject jsonObj = m_rest->getSync(cmd, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
QJsonObject Draco::ClaimingWalletTransactionGetOne(const QString &wallet_id, const QString &transaction_id)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_TX_GET_ONE];
    cmd.replace("{local_id}", wallet_id).replace("{transaction_id}", transaction_id);
    QJsonObject jsonObj = m_rest->getSync(cmd, QJsonObject(), reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
...
bool Draco::ClaimingWalletTransactionCancel(const QString &wallet_id, const QString &transaction_id)
{
    QJsonObject data;
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_TX_CANCEL];
    cmd.replace("{local_id}", wallet_id);
    cmd.replace("{transaction_id}", transaction_id);
    QJsonObject jsonObj = m_rest->deleteSync(cmd, data, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
...
bool Draco::ClaimingWalletTransactionRbf(const QString &wallet_id, const QString &transaction_id, const QString &psbt, QJsonObject &output, QString &errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_TX_RBF];
    cmd.replace("{local_id}",wallet_id);
    cmd.replace("{transaction_id}",transaction_id);
...
bool Draco::ClaimingWalletTransactionSync(const QString &wallet_id, const QString &psbt, QJsonObject &output, QString &errormsg)
{
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::CLAIMING_WALLET_TX_CREATE_UPDATE];
    cmd.replace("{local_id}", wallet_id);
...
bool Draco::CancelClaimingWalletTransactionGetList(const QString &wallet_id, int offset, int limit, QJsonObject &output, QString &errormsg) {
    QJsonObject data;
    data["offset"] = QString("%1").arg(offset);
    data["limit"] = QString("%1").arg(limit);
    data["statuses"] = "CANCELED";
...
bool Draco::TimeLockConvert(const QJsonObject& requestBody, QJsonObject &result) {
    int     reply_code = -1;
    QString reply_msg  = "";
    QString cmd = commands[Premium::CMD_IDX::TIMELOCK_CONVERT];
    QJsonObject jsonObj = m_rest->postSync(cmd, requestBody, reply_code, reply_msg);
    if(reply_code == DRACO_CODE::SUCCESSFULL){
        QJsonObject errorObj = jsonObj["error"].toObject();
        int response_code = errorObj["code"].toInt();
        QString response_msg = errorObj["message"].toString();
