...
#define DRAGON_SHARED_WALLETS_URL "https://api.nunchuk.io/v1.1/shared-wallets"
#define DRAGON_SHARED_WALLETS_TESTNET_URL "https://api-testnet.nunchuk.io/v1.1/shared-wallets"
...
inline QString commandByNetwork(const QString &cmd) {
    ...
    } else if ((int)AppSetting::Chain::TESTNET == AppSetting::instance()->primaryServer() && command.contains(DRAGON_SHARED_WALLETS_URL)) {
        command.replace(DRAGON_SHARED_WALLETS_URL, DRAGON_SHARED_WALLETS_TESTNET_URL);
    }
    return command;
}
...
enum CMD_IDX {
    ...
    INHERITANCE_CLAIM_SIGNING_CHALLENGE,
...
namespace Share {
enum CMD_IDX {
    SEND_INVITATION = Group::CMD_IDX::CMD_MAX + 1,   // POST /invitations
    GET_GROUP_INVITATIONS, // GET /invitations/groups/{group_id}
    REMOVE_INVITATION,     // DELETE /invitations/{invitation_id}
    GET_INVITATIONS,       // GET /invitations
    DENY_INVITATION        // POST /invitations/{invitation_id}/deny
};
}
...
enum class GROUP_WALLETS_STATUS { PENDING_WALLET, ACTIVE, DELETED };

enum class GROUP_ALERTS_STATUS { UNREAD, READ };
...
const QMap<int, QString> commands{
    ...
    {Premium::CMD_IDX::ASSISTED_WALLET_UPDATE_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/{transaction_id}")},
    ...
    {Premium::CMD_IDX::ASSISTED_WALLET_GET_LIST_TX_NOTES,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/notes")},
    ...
    {Premium::CMD_IDX::ASSISTED_WALLET_SIGN_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/sign")},
    {Premium::CMD_IDX::ASSISTED_WALLET_CANCEL_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/{transaction_id}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_GET_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/{transaction_id}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_SYNC_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/sync")},
    {Premium::CMD_IDX::ASSISTED_WALLET_RBF_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/rbf")},
    ...
    {Premium::CMD_IDX::ASSISTED_WALLET_REMOVE_WALLET_REQUIRED_SIGNATURES,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/calculate-required-signatures")},
    ...
    {Premium::CMD_IDX::USER_KEYS_CALCULATE_REQUIRED_SIGNATURES,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("user-keys/{key_id_or_xfp}/calculate-required-signatures")},
    ...
    {Premium::CMD_IDX::INHERITANCE_CLAIM_SIGNING_CHALLENGE, QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("inheritance/claiming/signing-challenge")},
    ...
    {Premium::CMD_IDX::SERVER_KEYS_REQUIRED_SIGNATURES,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("server-keys/{key_id_or_xfp}/calculate-required-signatures")},
    ...
    {Premium::CMD_IDX::ASSISTED_WALLET_ALERTS_READ,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/alerts/{alert_id}/mark-as-read")},
    {Premium::CMD_IDX::ASSISTED_WALLET_ALERTS_DISMISS,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/alerts/{alert_id}/dismiss")},

    // Wallet health check
    {Premium::CMD_IDX::ASSISTED_WALLET_GET_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/health/reminder")},
    {Premium::CMD_IDX::ASSISTED_WALLET_ADD_OR_UPDATE_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/health/reminder")},
    {Premium::CMD_IDX::ASSISTED_WALLET_DELETE_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/health/reminder")},
    {Premium::CMD_IDX::ASSISTED_WALLET_SKIP_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/health/reminder/{xfp}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_HEALTHCHECK,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/health/{xfp}/health-check")},
    ...
    // Dummy transaction
    {Premium::CMD_IDX::ASSISTED_WALLET_GET_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_UPDATE_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_CANCEL_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_FINALIZE_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}/finalize")},
    ...
    // Replace Wallet
    {Premium::CMD_IDX::ASSISTED_WALLET_CONFIGURE_WALLET_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/configs")},
    {Premium::CMD_IDX::ASSISTED_WALLET_INITIATE_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/{xfp}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_CANCEL_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/{xfp}")},
    {Premium::CMD_IDX::ASSISTED_WALLET_VERIFY_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/{xfp}/verify")},
    {Premium::CMD_IDX::ASSISTED_WALLET_REMOVE_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/{xfp}/remove")},
    {Premium::CMD_IDX::ASSISTED_WALLET_REPLACE_KEY,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/{xfp}/replace")},
    {Premium::CMD_IDX::ASSISTED_WALLET_FINALIZE_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/finalize")},
    {Premium::CMD_IDX::ASSISTED_WALLET_GET_STATUS_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/status")},
    {Premium::CMD_IDX::ASSISTED_WALLET_REPLACEMENT_TIMELOCK,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/timelock")},
    {Premium::CMD_IDX::ASSISTED_WALLET_RESET_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("wallets/{wallet_id_or_local_id}/replacement/reset")},
    {Premium::CMD_IDX::ASSISTED_WALLET_DOWNLOAD_BACKUP_KEY_REPLACEMENT,
    ...
    {Premium::CMD_IDX::DRAFT_WALLET_MARK_ALERT_AS_READ,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("draft-wallets/current/alerts/{alert_id}/mark-as-read")},
    ...
    {Group::CMD_IDX::GROUP_WALLET_EDIT_GROUP_MEMBERS_REQUIRED_SIGNATURES,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/members/calculate-requires-signatures")},
    ...
    {Group::CMD_IDX::GROUP_WALLET_REMOVE_WALLET_REQUIRED_SIGNATURES,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/calculate-required-signatures")},
    ...
    {Group::CMD_IDX::GROUP_WALLET_UPDATE_PRIMARY_OWNER,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/primary-owner")},
    ...
    {Group::CMD_IDX::GROUP_DRAFT_WALLETS_REQUEST_ADD_KEY,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/draft-wallets/request-add-key")},
    {Group::CMD_IDX::GROUP_DRAFT_WALLETS_DELETE_REQUEST_ADD_KEY,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/draft-wallets/request-add-key/{request_id}")},
    ...
    {Group::CMD_IDX::GROUP_WALLETS_GET_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/health/reminder")},
    {Group::CMD_IDX::GROUP_WALLETS_ADD_OR_UPDATE_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/health/reminder")},
    {Group::CMD_IDX::GROUP_WALLETS_DELETE_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/health/reminder")},
    {Group::CMD_IDX::GROUP_WALLETS_SKIP_KEY_HEALTH_REMINDER,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/health/reminder/{xfp}")},
    {Group::CMD_IDX::GROUP_WALLETS_REQUEST_HEALTHCHECK,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/health/{xfp}/request-health-check")},
    {Group::CMD_IDX::GROUP_WALLETS_HEALTHCHECK,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/health/{xfp}/health-check")},
    ...
    // Dummy transaction
    {Group::CMD_IDX::GROUP_WALLETS_GET_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}")},
    {Group::CMD_IDX::GROUP_WALLETS_UPDATE_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}")},
    {Group::CMD_IDX::GROUP_WALLETS_CANCEL_DUMMY_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}")},
    {Group::CMD_IDX::GROUP_WALLETS_FINALIZE_DUMMY_TX,
     QString("%1/%2")
         .arg(DRAGON_GROUP_WALLETS_URL)
         .arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/dummy-transactions/{dummy_transaction_id}/finalize")},

    // Group transactions
    {Group::CMD_IDX::GROUP_WALLETS_GET_ALL_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions")},
    {Group::CMD_IDX::GROUP_WALLETS_GET_ALL_TX_NOTES,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/notes")},
    {Group::CMD_IDX::GROUP_WALLETS_GET_ONE_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}")},
    {Group::CMD_IDX::GROUP_WALLETS_UPDATE_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}")},
    {Group::CMD_IDX::GROUP_WALLETS_CANCEL_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}")},
    {Group::CMD_IDX::GROUP_WALLETS_SYNC_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/sync")},
    {Group::CMD_IDX::GROUP_WALLETS_SIGN_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/sign")},
    {Group::CMD_IDX::GROUP_WALLETS_CREATE_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions")},
    {Group::CMD_IDX::GROUP_WALLETS_SCHEDULE_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/schedule")},
    {Group::CMD_IDX::GROUP_WALLETS_CANCEL_SCHEDULE_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/schedule")},
    {Group::CMD_IDX::GROUP_WALLETS_REQUEST_SIGNATURE_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/request-signature")},
    {Group::CMD_IDX::GROUP_WALLETS_RBF_TX,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/transactions/{transaction_id}/rbf")},
    ...
    {Group::CMD_IDX::SERVER_KEYS_REQUIRED_SIGNATURES,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/server-keys/{key_id_or_xfp}/calculate-required-signatures")},
    ...
    // Recurring payment
    {Group::CMD_IDX::GROUP_WALLET_RECURRING_PAYMENT_LIST,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/recurring-payment")},
    {Group::CMD_IDX::GROUP_WALLET_RECURRING_PAYMENT_CREATE,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/recurring-payment")},
    {Group::CMD_IDX::GROUP_WALLET_RECURRING_PAYMENT_GET,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/recurring-payment/{recurring_payment_id}")},
    {Group::CMD_IDX::GROUP_WALLET_RECURRING_PAYMENT_CANCEL,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/recurring-payment/{recurring_payment_id}")},

    // Replace Wallet
    {Group::CMD_IDX::GROUP_WALLET_CONFIGURE_WALLET_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/configs")},
    {Group::CMD_IDX::GROUP_WALLET_INITIATE_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/{xfp}")},
    {Group::CMD_IDX::GROUP_WALLET_CANCEL_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/{xfp}")},
    {Group::CMD_IDX::GROUP_WALLET_VERIFY_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/{xfp}/verify")},
    {Group::CMD_IDX::GROUP_WALLET_REMOVE_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/{xfp}/remove")},
    {Group::CMD_IDX::GROUP_WALLET_REPLACE_KEY,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/{xfp}/replace")},
    {Group::CMD_IDX::GROUP_WALLET_FINALIZE_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/finalize")},
    {Group::CMD_IDX::GROUP_WALLET_GET_STATUS_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/status")},
    {Group::CMD_IDX::GROUP_WALLET_REPLACEMENT_TIMELOCK,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/timelock")},
    {Group::CMD_IDX::GROUP_WALLET_RESET_KEY_REPLACEMENT,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/replacement/reset")},
    {Group::CMD_IDX::GROUP_WALLET_DOWNLOAD_BACKUP_KEY_REPLACEMENT,
    ...
    // Coin Control Group
    {Group::CMD_IDX::GROUP_WALLET_COINCONTROL_GET,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/coin-control")},
    {Group::CMD_IDX::GROUP_WALLET_COINCONTROL_UPDATE,
     QString("%1/%2").arg(DRAGON_GROUP_WALLETS_URL).arg("groups/{group_id}/wallets/{wallet_id_or_local_id}/coin-control")},
    ...
    {Premium::CMD_IDX::CLAIMING_WALLET_TX_GET_ONE,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("claiming-wallets/{local_id}/transactions/{transaction_id}")},
    ...
    {Premium::CMD_IDX::CLAIMING_WALLET_TX_CANCEL,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("claiming-wallets/{local_id}/transactions/{transaction_id}")},
    {Premium::CMD_IDX::CLAIMING_WALLET_TX_RBF,
     QString("%1/%2").arg(DRAGON_USER_WALLETS_URL).arg("claiming-wallets/{local_id}/transactions/{transaction_id}/rbf")},

    // Shared Wallet Invitations
    {Share::CMD_IDX::SEND_INVITATION, QString("%1/%2").arg(DRAGON_SHARED_WALLETS_URL).arg("invitations")},
    {Share::CMD_IDX::GET_GROUP_INVITATIONS, QString("%1/%2").arg(DRAGON_SHARED_WALLETS_URL).arg("invitations/groups/{group_id}")},
    {Share::CMD_IDX::REMOVE_INVITATION, QString("%1/%2").arg(DRAGON_SHARED_WALLETS_URL).arg("invitations/{invitation_id}")},
    {Share::CMD_IDX::GET_INVITATIONS, QString("%1/%2").arg(DRAGON_SHARED_WALLETS_URL).arg("invitations")},
    {Share::CMD_IDX::DENY_INVITATION, QString("%1/%2").arg(DRAGON_SHARED_WALLETS_URL).arg("invitations/{invitation_id}/deny")},
};
