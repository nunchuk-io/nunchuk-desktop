...
class AppStrings : public QObject {
    ...
    DEFINE_STRING_PROPERTY(STR_QML_2151, "Release schedule")
    DEFINE_STRING_PROPERTY(STR_QML_2152, "Change timezone")
    DEFINE_STRING_PROPERTY(STR_QML_2153, "Release method")
    DEFINE_STRING_PROPERTY(STR_QML_2154, "Beneficiary schedules")
    DEFINE_STRING_PROPERTY(STR_QML_2155, "Beneficiary details")
    DEFINE_STRING_PROPERTY(STR_QML_2156, "Fallback settings")
    DEFINE_STRING_PROPERTY(STR_QML_2157, "First withdrawal date")
    DEFINE_STRING_PROPERTY(STR_QML_2158, "Withdrawal rule")
    DEFINE_STRING_PROPERTY(STR_QML_2159, "Set up buffer period")
    DEFINE_STRING_PROPERTY(STR_QML_2160, "Set up buffer period")
    DEFINE_STRING_PROPERTY(STR_QML_2161, "Signatures required")
    DEFINE_STRING_PROPERTY(STR_QML_2162, "Multi Beneficiary Inheritance Plan Change")
    DEFINE_STRING_PROPERTY(STR_QML_2163, "Single Beneficiary Inheritance Plan Change")
    DEFINE_STRING_PROPERTY(STR_QML_2166, "Asset allocation")
    DEFINE_STRING_PROPERTY(STR_QML_2167, "Individual schedules")
    DEFINE_STRING_PROPERTY(STR_QML_2168, "Timezone")
    DEFINE_STRING_PROPERTY(STR_QML_2169, "Fallback settings")
    DEFINE_STRING_PROPERTY(STR_QML_2170, "Redistribute equally if no withdrawal occurs for %1 years after the last scheduled payout.")
    DEFINE_STRING_PROPERTY(STR_QML_2172, "First withdrawal date:")
    DEFINE_STRING_PROPERTY(STR_QML_2173, "Buffer period:")
    DEFINE_STRING_PROPERTY(STR_QML_2174, "Release:")
    DEFINE_STRING_PROPERTY(STR_QML_2175, "Expand")
    DEFINE_STRING_PROPERTY(STR_QML_2176, "Collapse")
    DEFINE_STRING_PROPERTY(STR_QML_2177, "Beneficiary")
    DEFINE_STRING_PROPERTY(STR_QML_2178, "Each stage represents a portion of the inheritance. All stages together equal the full inheritance (100%).")
    DEFINE_STRING_PROPERTY(STR_QML_2179, "Total allocated")
    DEFINE_STRING_PROPERTY(STR_QML_2180, "Add beneficiary")
    DEFINE_STRING_PROPERTY(STR_QML_2181, "Asset allocation")
    DEFINE_STRING_PROPERTY(STR_QML_2182, "Shared schedule")
    DEFINE_STRING_PROPERTY(STR_QML_2183, "Apply the same release schedule to all Beneficiaries. Simple and easy to manage.")
    DEFINE_STRING_PROPERTY(STR_QML_2185, "Customize release schedules for each Beneficiary to suit their individual needs.")
    DEFINE_STRING_PROPERTY(STR_QML_2186, "First withdrawal only")
    DEFINE_STRING_PROPERTY(STR_QML_2187, "Every withdrawal")
    DEFINE_STRING_PROPERTY(STR_QML_2188, "Stage")
    DEFINE_STRING_PROPERTY(STR_QML_2189, "Changing the time zone will update your existing schedule to follow the newly selected time zone. All previously set "
                                         "dates and times will automatically adjust accordingly.")
    DEFINE_STRING_PROPERTY(STR_QML_2190, "Decide what happens if a beneficiary doesn't claim their funds within a certain period")
    DEFINE_STRING_PROPERTY(STR_QML_2191, "No fallback")
    DEFINE_STRING_PROPERTY(STR_QML_2192, "If a beneficiary does not withdraw, the funds remain in the owner's wallet. No automatic redistribution will occur.")
    DEFINE_STRING_PROPERTY(STR_QML_2193, "Date-based fallback")
    DEFINE_STRING_PROPERTY(STR_QML_2194, "On a date you choose after the final payout, any unclaimed shares are redistributed to the other beneficiaries.")
    DEFINE_STRING_PROPERTY(STR_QML_2195, "Inactivity fallback")
    DEFINE_STRING_PROPERTY(STR_QML_2196, "If a beneficiary makes no withdrawals for the selected time after the final payout, their unclaimed share is "
                                         "redistributed to the other beneficiaries.")
    DEFINE_STRING_PROPERTY(STR_QML_2197, "Trigger")
    DEFINE_STRING_PROPERTY(STR_QML_2198, "after last payout")
    DEFINE_STRING_PROPERTY(STR_QML_2199, "year")
    DEFINE_STRING_PROPERTY(STR_QML_2200, "month")
    DEFINE_STRING_PROPERTY(STR_QML_2201, "week")
    DEFINE_STRING_PROPERTY(STR_QML_2202, "day")
    DEFINE_STRING_PROPERTY(STR_QML_2203,
                           "Each stage releases a portion of this beneficiary's allocated share, and all stages together equal 100% of their share.")
    DEFINE_STRING_PROPERTY(STR_QML_2204, "Add stage")
    DEFINE_STRING_PROPERTY(
        STR_QML_2205,
        "Set the first date withdrawals can begin for this stage. <b>Only on or after this date</b> can a Beneficiary or Trustee start claiming the inheritance.")
    DEFINE_STRING_PROPERTY(STR_QML_2206, "We recommend setting a timelock not too far in the future (e.g., 2 years from now).")
    DEFINE_STRING_PROPERTY(STR_QML_2207, "Time zone")
    DEFINE_STRING_PROPERTY(STR_QML_2208, "Time")
    DEFINE_STRING_PROPERTY(STR_QML_2209, "Define how much is withdrawn each time, how often withdrawals occur, and the total portion allocated to this stage.")
    DEFINE_STRING_PROPERTY(STR_QML_2210, "You can review and update these stage settings every year in the Services tab if needed.")
    DEFINE_STRING_PROPERTY(STR_QML_2211, "Amount per Release")
    DEFINE_STRING_PROPERTY(STR_QML_2212, "Repeat every")
    DEFINE_STRING_PROPERTY(STR_QML_2213, "Total stage allocation")
    DEFINE_STRING_PROPERTY(STR_QML_2214, "180-day buffer")
    DEFINE_STRING_PROPERTY(STR_QML_2215, "90-day buffer")
    DEFINE_STRING_PROPERTY(STR_QML_2216, "Decide how you would like to apply the buffer period to your inheritance plan.")
    DEFINE_STRING_PROPERTY(STR_QML_2217, "Buffer will only apply to the first withdrawal request.")
    ...
    DEFINE_STRING_PROPERTY(STR_QML_2224, "Asset allocation & Release method")
    DEFINE_STRING_PROPERTY(STR_QML_2225, "Total stage allocation cannot exceed 100%.")
    DEFINE_STRING_PROPERTY(STR_QML_2226, "On the date you choose, any funds that were released but not claimed will be redistributed.")
    DEFINE_STRING_PROPERTY(STR_QML_2227, "Add beneficiaries and decide how the asset is shared between them. <b>The total across all beneficiaries must be 100%.</b>")
    DEFINE_STRING_PROPERTY(STR_QML_2228, "Each beneficiary must use a unique email.")
    DEFINE_STRING_PROPERTY(STR_QML_2229, "Email cannot be empty.")
    DEFINE_STRING_PROPERTY(STR_QML_2230, "Beneficiary email invalid.")
    DEFINE_STRING_PROPERTY(STR_QML_2231, "Set how and when each Beneficiary receives their share.")
    DEFINE_STRING_PROPERTY(STR_QML_2232, "Amount per release must be greater than 0%.")
    DEFINE_STRING_PROPERTY(STR_QML_2233, "First withdrawal date must be later than the previous stage")
    DEFINE_STRING_PROPERTY(STR_QML_2234, "First withdrawal date must be sooner than the follower stage")
    DEFINE_STRING_PROPERTY(STR_QML_2235, "Magic phrases")
    DEFINE_STRING_PROPERTY(STR_QML_2236, "View release schedule")
    DEFINE_STRING_PROPERTY(STR_QML_2237, "How your inheritance is released")
    DEFINE_STRING_PROPERTY(STR_QML_2238, "Your inheritance is released over time, not all at once.")
    DEFINE_STRING_PROPERTY(STR_QML_2239, "It’s divided into stages. Each stage unlocks part of your inheritance. As time passes, withdrawals become available based on the schedule.")
    DEFINE_STRING_PROPERTY(STR_QML_2240, "When a withdrawal is available, you can claim that amount.")
    DEFINE_STRING_PROPERTY(STR_QML_2241, "This schedule shows when and how much of your inheritance becomes available to withdraw over time.")
    DEFINE_STRING_PROPERTY(STR_QML_2242, "Available balance: ")
    DEFINE_STRING_PROPERTY(STR_QML_2243, "Available to withdraw now")
    DEFINE_STRING_PROPERTY(STR_QML_2244, "Withdraw all available balance")
    DEFINE_STRING_PROPERTY(STR_QML_2245, "Delete stage")
    DEFINE_STRING_PROPERTY(STR_QML_2246, "Deleting this stage will permanently remove it and its allocated portion. You will need to redistribute that amount across the remaining stages.")
    DEFINE_STRING_PROPERTY(STR_QML_2247, "The remaining stages will be renumbered automatically.")
    DEFINE_STRING_PROPERTY(STR_QML_2248, "First withdrawal date must be later than current date.")
