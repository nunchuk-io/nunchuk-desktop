...
class SandboxWallet : public AssistedWallet {
    Q_OBJECT
    // Group wallet (global)
    Q_PROPERTY(bool isSandboxWallet                 READ isSandboxWallet        WRITE setIsSandboxWallet        NOTIFY isSandboxWalletChanged)
  ...
  public:
    ...
    bool isSandboxWallet() const;
    void setIsSandboxWallet(bool value);
    ...
    nunchuk::GroupWalletConfig nunchukConfig() const;
    int numberOnline();
