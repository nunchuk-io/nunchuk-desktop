...
#ifndef STATE_ID_SCR_INHERITANCE_TRANSACTION_DETAILS_H
#define STATE_ID_SCR_INHERITANCE_TRANSACTION_DETAILS_H
...
#endif // STATE_ID_SCR_INHERITANCE_TRANSACTION_DETAILS_H
