...
public:
    ...
    enum EVT_STATE_ID_ROOT
    {
        ...
        EVT_STATE_ID_ROOT_MAX                               , // 134
    };
    enum EVT_STATE_ID_SCR_HOME
    {
        EVT_STATE_ID_SCR_HOME_MIN=EVT_STATE_ID_ROOT_MAX+1, // 135
        EVT_HOME_WALLET_SELECTED                         , // 136
        EVT_HOME_WALLET_COPY_ADDRESS                     , // 137
        EVT_HOME_SETTING_REQUEST                         , // 138
        EVT_HOME_DISPLAY_ADDRESS                         , // 139
        EVT_HOME_IMPORT_PSBT                             , // 140
        EVT_HOME_EXPORT_BSMS                             , // 141
        EVT_HOME_MASTER_SIGNER_INFO_REQUEST              , // 142
        EVT_HOME_SEND_REQUEST                            , // 143
        EVT_HOME_RECEIVE_REQUEST                         , // 144
        EVT_HOME_TRANSACTION_HISTORY_REQUEST             , // 145
        EVT_HOME_WALLET_INFO_REQUEST                     , // 146
        EVT_HOME_TRANSACTION_INFO_REQUEST                , // 147
        EVT_HOME_REMOTE_SIGNER_INFO_REQUEST              , // 148
        EVT_HOME_COLDCARD_NFC_SIGNER_INFO_REQUEST        , // 149
        EVT_ASK_HARDWARE_REQ                             , // 150
        EVT_EXIST_HARDWARE_REQ                           , // 151
        EVT_SHOW_GROUP_WALLET_CONFIG_REQUEST             , // 152
        EVT_KEY_HEALTH_CHECK_STATUS_REQUEST              , // 153
        EVT_RECURRING_PAYMENTS_REQUEST                   , // 154
        EVT_ADD_HARDWARE_REQUEST                         , // 155
        EVT_ADD_SOFTWARE_SIGNER_RESULT                   , // 156
        EVT_REPLACE_KEYS_REQUEST                         , // 157
        EVT_STATE_ID_SCR_HOME_MAX                        , // 158
    };
    enum EVT_STATE_ID_SCR_ADD_WALLET
    {
        EVT_STATE_ID_SCR_ADD_WALLET_MIN=EVT_STATE_ID_SCR_HOME_MAX+1, // 159
        EVT_ADD_WALLET_IMPORT                                      , // 160
        EVT_ADD_WALLET_BACK_REQUEST                                , // 161
        EVT_ADD_WALLET_SIGNER_CONFIGURATION_REQUEST                , // 162
