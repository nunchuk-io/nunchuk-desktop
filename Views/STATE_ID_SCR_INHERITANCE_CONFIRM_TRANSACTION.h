...
#ifndef STATE_ID_SCR_INHERITANCE_CONFIRM_TRANSACTION_H
#define STATE_ID_SCR_INHERITANCE_CONFIRM_TRANSACTION_H
...
#endif // STATE_ID_SCR_INHERITANCE_CONFIRM_TRANSACTION_H
